...
These are simplified instructions for Ubuntu and Fedora. If a step doesn't work
or fit your case, please consult the sections below.
...
2. On Ubuntu: install Graphviz from source:
...
- libMØD:
  ...
  - A C++ compiler with reasonable C++14 support is needed. GCC 6.1 or later
    should work.
  - `Boost <http://boost.org>`__ dev >= 1.72
