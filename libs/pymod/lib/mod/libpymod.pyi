...
def _bondTypeToString(self) -> str: ...
...
class LabelType(enum.Enum):
	String: int
def _LabelType__str__(self) -> str: ...

class LabelRelation(enum.Enum):
	Isomorphism: int
def _LabelRelation__str__(self) -> str: ...
...
class IsomorphismPolicy(enum.Enum):
	Check: int
def _IsomorphismPolicy__str__(self) -> str: ...

class SmilesClassPolicy(enum.Enum): ...
def _SmilesClassPolicy__str__(self) -> str: ...
...
class DG:
	def __init__(self, *, labelSettings: LabelSettings=..., graphDatabase=..., graphPolicy=...) -> None: ...
...
class RCExpComposeCommon(RCExpExp):
	def __init__(self, first: RCExpExp, second: RCExpExp, discardNonchemical=bool, maximum=bool, connected=bool) -> None: ...
