...
class _Func_DoubleDGVertex:
	def __call__(self, v: DGVertex) -> float: ...
class _Func_StringDGVertex:
	def __call__(self, v: DGVertex) -> str: ...
class _Func_StringDGVertexInt:
	def __call__(self, v: DGVertex, dupNum: int) -> str: ...
...
class DGBuilder:
	...
	def addHyperEdge(self, e: DGHyperEdge, graphPolicy: IsomorphismPolicy = ...) -> DGHyperEdge: ...
...
class DGPrinter:
	...
	def setImageOverwrite(self, f: Union[Callable[[DGVertex, int], str], str]) -> None: ...
