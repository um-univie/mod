#ifndef MOD_LIB_IO_GML_HPP
#define MOD_LIB_IO_GML_HPP

#include <mod/lib/Stereo/IO/Read.hpp>
...
public:
	std::optional<lib::Stereo::Read::ParsedEmbedding> parsedEmbedding;
};
