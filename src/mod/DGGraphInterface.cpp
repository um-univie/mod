...
void DG::HyperEdge::print(const GraphPrinter &printer, const std::string &matchColour) const {
	...
	lib::IO::Derivation::Write::summary(g->getNonHyper(), v, printer.getOptions(), matchColour);
}
