#ifndef MOD_GRAPHGRAPHINTERFACE_H
#define MOD_GRAPHGRAPHINTERFACE_H

// rst: This header contains the defintinos for the graph interface for :cpp:class:`mod::Graph`.
// rst:
...
// rst-class: Graph::VertexIterator
// rst:
...
// rst-class: Graph::IncidnetEdgeIterator
// rst:
// rst:		An iterator for traversing all edges in a graph.
// rst:		It models a forward iterator.
// rst-class-start:
...
#endif /* MOD_GRAPHGRAPHINTERFACE_H */