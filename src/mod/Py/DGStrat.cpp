...
// rst: This section describes two interfaces for the derivation graph strategies; the basic API and an embedded language which is build on the basic API.
...
void DGStrat_doExport() {
	...
	// rst:
	py::class_<mod::DGStrat::GraphState>("DGStratGraphState", py::no_init)
			...
			// rst:
			.add_property("_subset", py::make_function(&mod::DGStrat::GraphState::getSubset, py::return_internal_reference<1>()))
			...
			// rst:			:type: list of :py:class:`Graph`
			// rst:
			.add_property("_universe", py::make_function(&mod::DGStrat::GraphState::getUniverse, py::return_internal_reference<1>()))
			// rst:		.. py:attribute:: derivationRefs
			// rst: 
			...
			// rst:
			// rst:			:type: list of :py:class:`DerivationRef`
			// rst:
			.add_property("_derivationRefs", py::make_function(&mod::DGStrat::GraphState::getDerivationRefs, py::return_internal_reference<1>()))
			;


	std::shared_ptr<mod::DGStrat> (*makeAdd_static)(bool, const std::vector<std::shared_ptr<mod::Graph> >&) = &mod::DGStrat::makeAdd;
	std::shared_ptr<mod::DGStrat> (*makeAdd_dynamic)(bool, const std::shared_ptr < mod::Function < std::vector<std::shared_ptr<mod::Graph> >() > >) = &mod::DGStrat::makeAdd;

	// rst: .. py:class:: DGStrat
	// rst: 
	py::class_<mod::DGStrat, std::shared_ptr<mod::DGStrat>, boost::noncopyable>("DGStrat", py::no_init)
			.def(str(py::self))
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeExecute", &mod::DGStrat::makeExecute).staticmethod("makeExecute")
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeFilter", &mod::DGStrat::makeFilter).staticmethod("makeFilter")
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeLeftPredicate", &mod::DGStrat::makeLeftPredicate).staticmethod("makeLeftPredicate")
			...
			.def("makeParallel", &mod::DGStrat::makeParallel).staticmethod("makeParallel")
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeRepeat", &mod::DGStrat::makeRepeat).staticmethod("makeRepeat")
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeRevive", &mod::DGStrat::makeRevive).staticmethod("makeRevive")
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeRightPredicate", &mod::DGStrat::makeRightPredicate).staticmethod("makeRightPredicate")
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeRule", &mod::DGStrat::makeRule).staticmethod("makeRule")
			...
			// rst:			:rtype: :class:`DGStrat`
			.def("makeSequence", &mod::DGStrat::makeSequence).staticmethod("makeSequence")
			.def("makeSort", &mod::DGStrat::makeSort).staticmethod("makeSort") // TODO: remove
			.def("makeTake", &mod::DGStrat::makeTake).staticmethod("makeTake") // TODO: remove
			;
}
