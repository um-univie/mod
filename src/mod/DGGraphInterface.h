#ifndef MOD_DGGRAPHINTERFACE_H
#define MOD_DGGRAPHINTERFACE_H

// rst: This header contains the defintinos for the hypergraph interface for :cpp:class:`mod::DG`.
// rst:
...
class DG::HyperEdge {
	friend class DerivationRef; // TODO: remove
...
// rst-class: DG::RuleIterator
// rst:
// rst:		An iterator for enumerating all rules of a hyperedge.
// rst:		It models a forward iterator.
// rst-class-start:

class DG::RuleIterator : public boost::iterator_facade<RuleIterator, std::shared_ptr<Rule>, std::forward_iterator_tag, std::shared_ptr<Rule> > {
