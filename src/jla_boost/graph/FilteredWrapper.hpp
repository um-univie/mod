...
source(typename boost::graph_traits<jla_boost::FilteredWrapper<Graph> >::edge_descriptor e, const jla_boost::FilteredWrapper<Graph> &g) {
	return source(e, g.g);
}

template<typename Graph>
typename boost::graph_traits<jla_boost::FilteredWrapper<Graph> >::vertex_descriptor
target(typename boost::graph_traits<jla_boost::FilteredWrapper<Graph> >::edge_descriptor e, const jla_boost::FilteredWrapper<Graph> &g) {
	return target(e, g.g);
}
...
in_edges(typename boost::graph_traits<jla_boost::FilteredWrapper<Graph> >::vertex_descriptor v, const jla_boost::FilteredWrapper<Graph> &g) {
